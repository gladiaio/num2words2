...
TEST_CASES_CARDINAL = (
    ...
    (
        1234567890,
        "один мільярд двісті тридцять чотири мільйони "
...
TEST_CASES_CARDINAL_GENITIVE = (
    ...
    (
        1234567890,
        "одного мільярда двохста тридцяти чотирьох мільйонів "
...
TEST_CASES_CARDINAL_DATIVE = (
    ...
    (
        1234567890,
        "одному мільярду двомстам тридцяти чотирьом мільйонам "
...
TEST_CASES_CARDINAL_INSTRUMENTAL = (
    ...
    (
        12519.85,
        "дванадцятьма тисячами п'ятьмастами дев'ятнадцятьма "
    ...
    (
        1234567890,
        "одним мільярдом двомастами тридцятьма чотирма мільйонами "
...
TEST_CASES_CARDINAL_LOCATIVE = (
    ...
    (
        1234567890,
        "одному мільярді двохстах тридцяти чотирьох мільйонах "
...
TEST_CASES_ORDINAL = (
    ...
    (956000000000000000000000000000000, "дев'ятсотп'ятдесятишестинонільйонний"),
)
...
class Num2WordsUKTest(TestCase):
    ...
    def test_to_ordinal(self):
        for test in TEST_CASES_ORDINAL:
            self.assertEqual(num2words(test[0], lang="uk", to="ordinal"), test[1])

    def test_to_currency(self):
        for test in TEST_CASES_TO_CURRENCY_AED:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="AED"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_AFN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="AFN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ALL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ALL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_AMD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="AMD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ANG:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ANG"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_AOA:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="AOA"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ARS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ARS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_AUD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="AUD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_AWG:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="AWG"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_AZN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="AZN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BAM:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BAM"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BBD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BBD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BDT:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BDT"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BGN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BGN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BHD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BHD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BIF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BIF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BMD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BMD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BND:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BND"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BOB:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BOB"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BRL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BRL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BSD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BSD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BTN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BTN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BWP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BWP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BYN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BYN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="BZD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CAD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CAD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CDF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CDF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CHF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CHF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CLP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CLP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CNY:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CNY"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_COP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="COP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CRC:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CRC"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CUC:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CUC"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CUP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CUP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CVE:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CVE"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_CZK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="CZK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_DJF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="DJF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_DKK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="DKK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_DOP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="DOP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_DZD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="DZD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_EGP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="EGP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ERN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ERN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ETB:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ETB"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_EUR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="EUR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_FJD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="FJD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_FKP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="FKP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GBP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GBP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GEL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GEL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GHS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GHS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GIP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GIP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GMD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GMD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GNF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GNF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GTQ:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GTQ"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_GYD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="GYD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_HKD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="HKD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_HNL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="HNL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_HRK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="HRK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_HTG:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="HTG"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_HUF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="HUF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_IDR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="IDR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ILS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ILS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_INR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="INR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_IQD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="IQD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_IRR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="IRR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ISK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ISK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_JMD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="JMD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_JOD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="JOD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_JPY:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="JPY"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KES:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KES"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KGS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KGS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KHR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KHR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KMF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KMF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KPW:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KPW"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KRW:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KRW"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KWD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KWD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KYD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KYD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_KZT:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="KZT"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_LAK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="LAK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_LBP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="LBP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_LKR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="LKR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_LRD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="LRD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_LSL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="LSL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_LYD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="LYD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MAD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MAD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MDL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MDL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MGA:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MGA"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MKD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MKD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MMK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MMK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MNT:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MNT"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MOP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MOP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MRU:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MRU"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MUR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MUR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MVR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MVR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MWK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MWK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MXN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MYR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MYR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_MZN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="MZN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_NAD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="NAD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_NGN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="NGN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_NIO:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="NIO"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_NOK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="NOK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_NPR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="NPR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_NZD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="NZD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_OMR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="OMR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_PAB:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="PAB"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_PEN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="PEN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_PGK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="PGK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_PHP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="PHP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_PKR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="PKR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_PLN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="PLN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_PYG:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="PYG"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_QAR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="QAR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_RON:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="RON"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_RSD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="RSD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_RUB:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="RUB"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_RWF:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="RWF"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SAR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SAR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SBD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SBD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SCR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SCR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SDG:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SDG"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SEK:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SEK"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SGD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SGD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SHP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SHP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SLL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SLL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SOS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SOS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SRD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SRD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SSP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SSP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_STN:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="STN"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SYP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SYP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_SZL:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="SZL"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_THB:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="THB"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TJS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TJS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TMT:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TMT"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TND:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TND"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TOP:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TOP"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TRY:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TRY"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TTD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TTD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TWD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TWD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_TZS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="TZS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_UAH:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="UAH"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_UGX:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="UGX"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="USD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_UYU:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="UYU"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_UZS:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="UZS"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_VND:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="VND"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_WST:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="WST"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_XCD:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="XCD"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_YER:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="YER"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ZAR:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ZAR"), test[1]
            )
        for test in TEST_CASES_TO_CURRENCY_ZMW:
            self.assertEqual(
                num2words(test[0], lang="uk", to="currency", currency="ZMW"), test[1]
            )
